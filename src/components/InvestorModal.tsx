...
const InvestorModal = ({ open, onOpenChange }: Props) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] sm:max-w-lg p-0 gap-0 border-none shadow-2xl overflow-hidden rounded-lg max-h-[95vh] sm:max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <div className="px-2 sm:px-8 pb-2 sm:pb-8 overflow-y-auto flex-1 min-h-0">
          <iframe
            src="https://api.onsync.ai/widget/form/zBg28F7Ctrpy0xGzBsSe"
            className="w-full border-none"
            style={{ minHeight: '400px', height: '70vh', maxHeight: '500px' }}
